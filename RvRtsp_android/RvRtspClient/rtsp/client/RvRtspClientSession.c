                    ...
                    IN RvRtspResponse   *pResponse)
{
    ...
    __android_log_print(ANDROID_LOG_ERROR, "RtspSessionHandleResponse", "hSessionId(%x),cseq(%d)", pThis->hSessionId, pResponse->cSeq.value);
                        ...
                        IN  RvBool                  waitingForResponse)
{
    ...
    __android_log_print(ANDROID_LOG_ERROR, "RtspSessionSendRequest", "hSessionId(%x),seq(%d)", pThis->hSessionId, pRequest->cSeq.value);
 ...
 *************************************************************************/
                ...
                IN void *context)
 {
    ...
    pRequest->requestLine.method  = RV_RTSP_METHOD_GET_PARAMETER;

    __android_log_print(ANDROID_LOG_ERROR, "RtspSessionOnPingTimer", "session=%p", context);
