...
/*@*****************************************************************************
* Type: RvStatus (RvCommonBaseTypesPkg)
* -----------------------------------------------------------------------------
* RADVISION API return code.
****************************************************************************@*/
...
#define RV_ERROR_LIBCODE_OS 13
#define RV_ERROR_LIBCODE_LDAP 14
#define RV_ERROR_LIBCODE_ADDRBOOK 15

#define RvOsError(s) RvErrorCode(RV_ERROR_LIBCODE_OS, 0, s)
#define RvLdapError(s) RvErrorCode(RV_ERROR_LIBCODE_LDAP, 0, s)
#define RvAddrBookErrorCode(s) RvErrorCode(RV_ERROR_LIBCODE_ADDRBOOK, 0, s)
