...
namespace xt_media_client
{
    ...
    protected:
        void dump_rtp_frame_data(uint8_t *data, uint32_t length, const rtp_fixed_header_t& params);
    ...
    protected:
        ...
        bool unpack_frame_start(const rtp_fixed_header_t& params);
        bool unpack_frame_cont(const rtp_fixed_header_t& params);
        bool unpack_frame_end(const rtp_fixed_header_t& params);

        bool unpack_single_frame(uint8_t *data, uint32_t length, const rtp_fixed_header_t& params);
        ...
        void dump_rtp_frame_data(const rtp_fixed_header_t& params);
    ...
    protected:
        bool unpack_frame_start(uint8_t nal_type, const rtp_fixed_header_t& params);
        bool unpack_single_frame(uint8_t nal_type, uint8_t *data, uint32_t length, const rtp_fixed_header_t& params);
        void write_start_sequence(uint8_t nal_type);
        void set_frame_type(uint32_t frame_type);

        virtual bool is_priv_Iframe(uint8_t nal_type) = 0;
