...
#if (RV_OS_TYPE == RV_OS_TYPE_PSOS) || (RV_OS_TYPE == RV_OS_TYPE_INTEGRITY)
#define RV_LOGLISTENER_TYPE  RV_LOGLISTENER_TERMINAL
#elif (RV_OS_TYPE == RV_OS_TYPE_NUCLEUS)
#define RV_LOGLISTENER_TYPE  RV_LOGLISTENER_UDP
#define RV_UDP_LOGGER_DEST_IP      "192.216.100.100"
#define RV_UDP_LOGGER_DEST_PORT    5566
#else
...
#define RV_DNS_CACHE_PAGE_SIZE 512
...
#ifdef RV_ASSERT_ENABLE
#undef RV_ASSERT_ENABLE
#endif
#define RV_ASSERT_ENABLE RV_NO
#endif

#if defined(RV_LDAP_ON)
#undef  RV_LDAP_TYPE
#define RV_LDAP_TYPE RV_LDAP_OPENLDAP
#endif /* defined(RV_LDAP_ON */
