...
#  ifndef NET_VERSION_COMP
#    error "NET_VERSION_COMP not found"
#  endif

#  ifndef HAS_NONBLOCKEDCONNECT
#    if NET_VERSION_COMP >= NET_5_2
#      define HAS_NONBLOCKEDCONNECT 1
#    else
#      define HAS_NONBLOCKEDCONNECT 0
#    endif
 ...
 * Returns whether the type of service (DiffServ Code Point) set/get
 * on the socket is supported.
 * This function is thread-safe.
 * INPUT   : None
 * OUTPUT  : None
 * RETURN  : RV_TRUE if ToS is supported, RV_FALSE otherwise
*/
RVCOREAPI
...
#ifdef RV_SOCKET_HAS_BACKGROUND
RVCOREAPI
RvStatus RVCALLCONV RvSocketSetBackground(
    IN RvSocket *sock, 
    IN RvBool bOn, 
    IN RvLogMgr *logMgr);
RVCOREAPI
RvStatus RVCALLCONV RvSocketGetBackground(
    IN RvSocket *sock, 
    OUT RvBool  *bOn, 
    IN RvLogMgr *logMgr);
#else
#define RvSocketSetBackground(sock, bOn, logMgr) ((void)(sock), (void)(bOn), (void)(logMgr), RV_ERROR_NOTSUPPORTED)
#define RvSocketGetBackground(sock, bOn, logMgr) ((void)(sock), (void)(bOn), (void)(logMgr), RV_ERROR_NOTSUPPORTED)
#endif
 ...
 *           remoteAddress - Address where to send the buffers to.
...
/* Various socket options set on the socket created with RvSocketConstruct2 */
#define RV_SOCKET_OPT_KEEP_ALIVE        0x0001
#define RV_SOCKET_OPT_TCP_DELAY         0x0002
#define RV_SOCKET_OPT_LINGER            0x0004
#define RV_SOCKET_OPT_REUSE_ADDR        0x0008
