...
#if !defined(RV_DNS_CACHE_MAXBIGPAGES_SIZE) || (RV_DNS_CACHE_MAXBIGPAGES_SIZE == 0)
#   if defined(RV_DNS_CACHE_MAXBIGPAGES_SIZE)
...
#define RvAresCacheCltFind(env, qtype, name, nameSize, domainSuffixes, nDomains, domainMask,  cb, cbCtx, qid) \
    RvAresCacheDFind(env, qtype, name, nameSize, domainSuffixes, nDomains, domainMask, cb, cbCtx, qid)
