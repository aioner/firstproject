...
#elif (RV_OS_VERSION == RV_OS_LINUX_REDHAT_C)
#define RV_OS_STRING "Linux Client"
...
#elif (RV_OS_VERSION == RV_OS_LINUX_DEBIAN)
#define RV_OS_STRING "Debian"
#elif (RV_OS_VERSION == RV_OS_LINUX_GENERIC_LINUX)
#define RV_OS_STRING "Generic Linux"
#else
...
#define RV_OS_STRING "Nucleus Net 4.4"
#elif (RV_OS_VERSION == RV_OS_NUCLEUS_5_3_2)
#define RV_OS_STRING "Nucleus Net 5.3.2"
#else
#define RV_OS_STRING "Nucleus"
#endif

#elif (RV_OS_TYPE == RV_OS_TYPE_INTEGRITY)
#if (RV_OS_VERSION == RV_OS_INTEGRITY_5_0)
#define RV_OS_STRING "INTEGRITY 5.0"
#elif (RV_OS_VERSION == RV_OS_INTEGRITY_4_0)
...
#elif (RV_OS_VERSION == RV_OS_MAC_DARWIN_9)
#define RV_OS_STRING "MAC Darwin 9"
#elif (RV_OS_VERSION == RV_OS_MAC_DARWIN_10)
#define RV_OS_STRING "MAC Darwin 10"
#else
#define RV_OS_STRING "MAC Darwin"
#endif

#elif (RV_OS_TYPE == RV_OS_TYPE_IPHONE)
#define RV_OS_STRING "iPhone"
...
#elif (RV_TOOL_VERSION == RV_TOOL_GNU_4_0)
#define RV_TOOL_STRING "GNU 4.0"
...
#elif (RV_TOOL_VERSION == RV_TOOL_MSVC_9)
#define RV_TOOL_STRING "Visual C 2008"
#else
