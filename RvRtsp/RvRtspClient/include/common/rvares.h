...
#define RV_ARES_OPT_LOCAL_ADDR 1
...
*
* Change the default parameters for a DNS engine. 
* Should replace RvAresSetParams
* Currently defined opcodes:
* RV_ARES_SOCKADDR - sets local address for DNS requests
*  'data' field of RvAresOpt should point to RvAddress structure
*
*/ 
