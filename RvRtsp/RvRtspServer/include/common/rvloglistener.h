...
#define RvLogListenerConstructLogfile(_listener, _logMgr, _fileName, _numFiles, _fileSize, _flushEachMessage) \
    (*_listener = RV_OK)
#define RvLogListenerFlushFiles(_logMgr) 
#define RvLogListenerReconfigureLogfile(_listener, _logMgr, _fileName, _numFiles, _fileSize, _flushEachMessage, _printMilliSecs, _ext) \
    (*_listener = RV_OK)
#define RvLogListenerGetLogfile(_logMgr) (NULL)
