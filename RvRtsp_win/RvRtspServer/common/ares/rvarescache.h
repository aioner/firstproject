...
#elif RV_DNS_CACHE_PAGE_SIZE < RV_DNS_CACHE_MIN_PAGE_SIZE
#  undef RV_DNS_CACHE_PAGE_SIZE
#  define RV_DNS_CACHE_PAGE_SIZE RV_DNS_CACHE_MIN_PAGE_SIZE
#endif

#if (RV_DNS_CACHE_MINPAGES == 0) && (RV_DNS_CACHE_MAXPAGES != 0)
...
#  undef RV_DNS_CACHE_MINPAGES
#  define RV_DNS_CACHE_MINPAGES 64
#endif

#if RV_DNS_CACHE_MAXPAGES == 0
#  undef RV_DNS_CACHE_MAXPAGES 
#  define RV_DNS_CACHE_MAXPAGES RV_DNS_CACHE_MINPAGES
#endif
...
#define RvAresCacheDCancelQuery(cached, qid) ((void)(cached), (void)(qid), (RV_OK))
...
#define RvAresCacheCltCancelQuery(env, qid) RvAresCacheDCancelQuery((env)->cached, qid)
