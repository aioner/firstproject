...
struct RvSelectEngineInternal
{
    ...
    HANDLE                  interfaceMonitorEvent;
    RvBool                  interfaceChangeDetected;
    RvOnAddressChange       onAddressChangeListenerers[RV_ADDR_MONITOR_MAX_LISTENERES];
    void*                   onAddressChangeListenerersCtx[RV_ADDR_MONITOR_MAX_LISTENERES];
    RvInt                   onAddressChangeListenerersCnt;
    RvAddress               currentAddrs[RV_ADDR_MONITOR_MAX_CURRADDRS];
    RvInt                   currentAddrsNum;
    ...
    RvBool                  mainLoopStopped;    /* this flag impacts the main loop run by select engine */
