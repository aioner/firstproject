...
#   include <stdarg.h>
    ...
    int rpl_sprintf(char *str, const char *format, ...);
    ...
    int rpl_vsprintf(char *str, const char *format, va_list args);


#   define RvSprintf  rpl_sprintf
#   define RvSnprintf  rpl_snprintf
#   define RvVsprintf rpl_vsprintf
#   define RvVsnprintf rpl_vsnprintf
